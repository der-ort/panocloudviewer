...
export function WorkstationLayout({ viewport, sidebarSide = "left" }: WorkstationLayoutProps) {
  ...
  return (
    <div className="relative w-full h-full overflow-hidden bg-[hsl(var(--background))]">
      ...
      <div className="absolute bottom-0 left-0 right-0 z-10 px-3 h-6 flex items-center gap-4 text-[10px] font-mono text-muted-foreground/70 bg-[hsl(var(--card)/0.8)] backdrop-blur-sm border-t border-[hsl(var(--border)/0.5)]">
